...
--
-- Host: localhost
-- Generation Time: Feb 01, 2018 at 03:09 PM
...
(35, 'mail@mail.com', '7c3607b8e61bcf1944e9e8503a660f21f4b6f3f1', 123456789, 'SAMSUNG', '123456789123456', '50.00'),
...
INSERT INTO `items` (`id`, `title`, `image`, `price`, `details`, `sub_category_id`) VALUES
(4, 'Ultimate Fruit', 'Veggie-Blends.jpg', '10.99', 'Item Details', 1),
(5, 'Berry Banana', 'Banana.jpg', '5.99', 'Item Details', 1),
(6, 'Tropical Sunshine', 'tropical-sunshine.jpg', '20.99', 'Item Details', 1),
(7, 'BeeT IT', 'beets.jpg', '29.99', 'Item Details', 2),
(8, 'Crazy For Carrots', 'carrots.jpg', '10.99', 'Item Details', 2),
(9, 'Muddy Peanut Butter', 'peanut-butter.jpg', '13.99', 'Details', 4),
(10, 'Mad Mango', 'mango.jpg', '15.39', 'Details', 4),
(11, 'Sunny Delight', 'sunny-delight.jpg', '9.99', 'Details', 3),
(12, 'Banana Split', 'Banana.jpg', '5.99', 'Details', 3);
...
ALTER TABLE `order_addon`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `addon_id` (`addon_id`),
