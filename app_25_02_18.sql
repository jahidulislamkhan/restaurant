...
--
-- Host: localhost
-- Generation Time: Feb 25, 2018 at 02:18 PM
...
(42, 'demouser@gmail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', 123456789, 'SAMSUNG-GT-2900', '1234567890', 40.00),
...
CREATE TABLE `orders` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '2=Delivered, 1=Pending, 3=Canceled',
...
INSERT INTO `orders` (`id`, `customer_id`, `item_id`, `quantity`, `unit_price`, `item_price`, `addon_price`, `total_price`, `status`, `order_date`) VALUES
(1519566846, 42, 4, 2, 200.00, 400.00, 1.47, 401.47, 2, '2018-02-25 19:54:06'),
(1519566846, 42, 5, 3, 140.00, 420.00, 2.07, 422.07, 2, '2018-02-25 19:54:07'),
(1519566863, 42, 4, 2, 200.00, 400.00, 1.47, 401.47, 3, '2018-02-25 19:54:23'),
(1519566863, 42, 5, 3, 140.00, 420.00, 2.07, 422.07, 3, '2018-02-25 19:54:23'),
(1519566865, 42, 4, 2, 200.00, 400.00, 1.47, 401.47, 1, '2018-02-25 19:54:25'),
(1519566865, 42, 5, 3, 140.00, 420.00, 2.07, 422.07, 1, '2018-02-25 19:54:25');
...
INSERT INTO `sales` (`id`, `customer_id`, `item_id`, `quantity`, `unit_price`, `item_price`, `addon_price`, `total_price`, `sales_date`) VALUES
(1519566846, 42, 4, 2, 200.00, 400.00, 1.47, 401.47, '2018-02-25 20:16:09'),
(1519566846, 42, 5, 3, 140.00, 420.00, 2.07, 422.07, '2018-02-25 20:16:10');
...
INSERT INTO `sales_addon` (`id`, `sales_id`, `item_id`, `addon_id`) VALUES
(85, 1519566846, 4, 1),
(86, 1519566846, 4, 2),
(87, 1519566846, 4, 3),
(88, 1519566846, 5, 4),
...
INSERT INTO `sales_recipe` (`id`, `sales_id`, `item_id`, `recipe_id`) VALUES
(85, 1519566846, 4, 5),
(86, 1519566846, 4, 6),
(87, 1519566846, 4, 7),
(88, 1519566846, 5, 8),
...
ALTER TABLE `sales_addon`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_sales_addon_order_id` (`sales_id`),
...
ALTER TABLE `sales_recipe`
  ...
  ADD KEY `FK_sales_recipe_order_id` (`sales_id`),
...
ALTER TABLE `sales_addon`
  ...
  ADD CONSTRAINT `FK_sales_addon_sales_id` FOREIGN KEY (`sales_id`) REFERENCES `sales` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `sales_recipe`
--
ALTER TABLE `sales_recipe`
  ADD CONSTRAINT `FK_sales_recipe_item_id` FOREIGN KEY (`item_id`) REFERENCES `items` (`id`),
  ADD CONSTRAINT `FK_sales_recipe_recipe_id` FOREIGN KEY (`recipe_id`) REFERENCES `recipes` (`id`),
  ADD CONSTRAINT `FK_sales_recipe_sales_id` FOREIGN KEY (`sales_id`) REFERENCES `sales` (`id`);
